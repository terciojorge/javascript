import { catalogo, salvarLocalStorage, lerLocalStore } from "./ultilidades";
...
function desenharProdutoCarrinho(idProduto){
    ...
    for( const articleClass of articleClasses){
        elementoArticle.classList.add(articleClass);// <article class="flex bg-slate-100 rounded-lg p-1 relative"></article>
    }
